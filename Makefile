...
alpine_ppc64le_libvirt:
	SETUP_WAIT="5m" BOOT_WAIT="2m" MACHINE_TYPE="pseries" ISO_CHECKSUM="sha256:b1f552d2ebdf8842d5e0965194fc64c12c5f713e331c043ab1af5f68f32bef5f" ISO_URL="https://dl-cdn.alpinelinux.org/alpine/v3.12/releases/ppc64le/alpine-standard-3.12.0-ppc64le.iso" ARCH="ppc64le" ALPINE_VERSION="3.12.0" packer build alpine-libvirt.json
clean:
	rm -rf packer-*
